...
<div class="row justify-content-center">
    <div class="col-md-5">
        <div class="card mt-5 shadow-sm">
            <div class="card-header text-center bg-white border-bottom-0 pt-4">
                ...
                <p class="text-muted small">ระบบจัดการข้อมูลสโมสรนักศึกษา</p>
            </div>
                ...
                <form action="<?= base_url('auth/process') ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="กรอกรหัสนักศึกษา" required autofocus>
                        </div>
                    </div>
    ...
    <option value="admin">ผู้ดูแลระบบ</option>
            ...
            <div class="card-footer text-center py-3 bg-light">
                <small>ยังไม่มีบัญชี? <a href="<?= base_url('register') ?>" class="text-decoration-none fw-bold">ลงทะเบียนสำหรับนักศึกษา</a></small>
            </div>
        </div>
    </div>
</div>
