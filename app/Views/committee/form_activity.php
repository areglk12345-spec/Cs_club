                ...
                <div class="card-body">
                    <form action="<?= base_url('committee/activity/save') ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="activity_name" class="form-control" required placeholder="เช่น กิจกรรมรับน้อง, อบรม Python">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">รายละเอียด</label>
                            <textarea name="description" class="form-control" rows="4" placeholder="รายละเอียดกิจกรรม..."></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="location" class="form-control" required placeholder="เช่น ห้องประชุม 1, ลานกิจกรรม">
                        </div>
