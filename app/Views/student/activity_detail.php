        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 fw-bold"><i class="fas fa-calendar-alt text-danger"></i> เริ่มกิจกรรม:</div>
                ...
                <div class="card-body text-center">
                    ...
                    <?php else : ?>
                        ...
                        <form action="<?= base_url('student/activity/register') ?>" method="post">
                            ...
                            <button type="submit" class="btn btn-primary w-100 btn-lg" onclick="return confirm('ยืนยันการลงทะเบียน?');">
                                ลงทะเบียนเข้าร่วม
                            </button>
                        </form>
                    <?php endif; ?>
